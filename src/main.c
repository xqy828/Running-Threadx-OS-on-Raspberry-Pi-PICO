...
void    thread_0_entry(ULONG thread_input)
{
    ...
    while(1)
    {
        ...
        printf("           Thread 0 Counter:            0x%08x\n", thread_0_counter);
        printf("           Thread 1 Counter:            0x%08x\n", thread_1_counter);
        printf("           Thread 2 Counter:            0x%08x\n", thread_2_counter);
        printf("           Thread 3 Counter:            0x%08x\n", thread_3_counter);
        printf("           Thread 4 Counter:            0x%08x\n", thread_4_counter);
        printf("           Thread 5 Counter:            0x%08x\n", thread_5_counter);
        printf("           Thread 6 Counter:            0x%08x\n", thread_6_counter);
        printf("           Thread 7 Counter:            0x%08x\n\n", thread_7_counter);
        /* Sleep for 100 ticks.  */
        tx_thread_sleep(100);
        gpio_put(LED_PIN, 0);
        tx_thread_sleep(100);
